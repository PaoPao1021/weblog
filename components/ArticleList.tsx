...
export function ArticleList({ c, language, category, posts, onCategory }: Props) {
  return <div className="articles-column">
    <div className="section-heading"><div><span className="section-kicker">{c.latestKicker}</span><h2 id="articles-title">{c.latest}</h2></div><a href="#articles">{c.archive} <span>↗</span></a></div>
